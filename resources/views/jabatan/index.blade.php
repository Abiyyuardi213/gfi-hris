    ...
    <script>
        $(function() {
            ...
            $('.toggle-status').change(function() {
                ...
                $.post("{{ url('jabatan') }}/" + id + "/toggle-status", {
                    _token: "{{ csrf_token() }}"
                }, function(res) {
                    if (res.success) {
                        Toast.fire({
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                text: "Apakah Anda yakin ingin menghapus jabatan ini? Tindakan ini tidak dapat dibatalkan.",
                icon: 'warning',
