                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-warning">
                        <div class="card-header">
                            <h3 class="card-title">
                                <i class="fas fa-edit"></i> Form Ubah Jabatan
                            </h3>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="gaji_per_hari"
                                        ...
                                        value="{{ old('gaji_per_hari', $jabatan->gaji_per_hari) }}" required>
                                    @error('gaji_per_hari')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="3">{{ old('deskripsi', $jabatan->deskripsi) }}</textarea>
                                    @error('deskripsi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control @error('status') is-invalid @enderror"
                                        required>
                                        <option value="1"
                                            {{ old('status', $jabatan->status) == 1 ? 'selected' : '' }}>Aktif</option>
                                        <option value="0"
                                            {{ old('status', $jabatan->status) == 0 ? 'selected' : '' }}>Nonaktif
                                        </option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
