...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="ml-auto">
                                <button class="btn btn-success btn-sm mr-2" onclick="syncAPI()">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button class="btn btn-warning btn-sm edit-kota-btn"
                                                        ...
                                                        data-id="{{ $kota->id }}" data-kota="{{ $kota->kota }}"
                                                        data-tipe="{{ $kota->tipe }}">
    ...
    <script>
        ...
        function syncAPI() {
            Swal.fire({
                title: 'Sinkronasi Data Kota',
                text: 'Mohon tunggu, sedang mengambil data dari API Wilayah Indonesia...',
                ...
                error: function(xhr) {
                    Swal.fire({
                        ...
                        text: xhr.responseJSON ? xhr.responseJSON.message :
                            'Terjadi kesalahan saat sinkronasi.'
                    });
                }
            });
        }
        ...
        $(document).on('click', '.delete-kota-btn', function() {
            let id = $(this).data('id');
            $('#deleteForm').attr('action', "{{ route('kota.index') }}/" + id);
        });
        ...
        $(document).on('click', '.edit-kota-btn', function() {
            ...
            $('#editKotaForm').attr('action', "{{ route('kota.index') }}/" + id);
        });
    </script>
