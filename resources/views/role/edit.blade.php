                        ...
                        <div class="card-body">
                            <form action="{{ route('role.update', $role->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('role_description') is-invalid @enderror" name="role_description" required
                                        placeholder="Masukkan deskripsi peran">{{ old('role_description', $role->role_description) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('role_status') is-invalid @enderror"
                                        ...
                                        <option value="1"
                                            {{ old('role_status', $role->role_status) == 1 ? 'selected' : '' }}>Aktif
                                        </option>
                                        <option value="0"
                                            {{ old('role_status', $role->role_status) == 0 ? 'selected' : '' }}>Nonaktif
                                        </option>
                                    </select>
                                    @error('role_status')
                                        <div class="invalid-feedback">{{ $message }}</div>
