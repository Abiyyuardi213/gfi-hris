...
<head>
    ...
    <title>GFI HRIS - Edit Hari Libur</title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_libur"
                                                ...
                                                value="{{ old('nama_libur', $hariLibur->nama_libur) }}" required>
                                            @error('nama_libur')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="is_cuti_bersama"
                                                ...
                                                <option value="0"
                                                    {{ old('is_cuti_bersama', $hariLibur->is_cuti_bersama) == '0' ? 'selected' : '' }}>
                                                    Libur Nasional / Biasa</option>
                                                <option value="1"
                                                    {{ old('is_cuti_bersama', $hariLibur->is_cuti_bersama) == '1' ? 'selected' : '' }}>
                                                    Cuti Bersama</option>
                                            </select>
                                            ...
                                            <select name="kantor_id"
                                                ...
                                                @foreach ($kantors as $kantor)
                                                    <option value="{{ $kantor->id }}"
                                                        {{ old('kantor_id', $hariLibur->kantor_id) == $kantor->id ? 'selected' : '' }}>
                                                        {{ $kantor->nama_kantor }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="3">{{ old('deskripsi', $hariLibur->deskripsi) }}</textarea>
                                            @error('deskripsi')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
