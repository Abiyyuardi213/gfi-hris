...
<head>
    ...
    <title>Tambah Divisi Jabatan</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Tambah Divisi Jabatan</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                <div class="card card-primary">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="fas fa-plus-circle"></i> Form Tambah Divisi Jabatan
                        </h3>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('divisi-jabatan.store') }}" method="POST">
                            @csrf
                            <!-- Divisi -->
